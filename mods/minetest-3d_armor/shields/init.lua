...
--Ajout du bouclier en mese
if ARMOR_MATERIALS.mese then
	minetest.register_tool("shields:shield_mese", {
		description = "mese Shield",
		inventory_image = "shields_inv_shield_mese.png",
		groups = {armor_shield=12, armor_heal=8, armor_use=250},
		wear = 0,
	})
end
