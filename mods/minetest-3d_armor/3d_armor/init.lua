...
--Ajout de l'armure en mese
if ARMOR_MATERIALS.mese then
	minetest.register_tool("3d_armor:helmet_mese", {
		description = "Mese Helmet",
		inventory_image = "3d_armor_inv_helmet_mese.png",
		groups = {armor_head=12, armor_heal=8, armor_use=250},
		wear = 0,
	})
	minetest.register_tool("3d_armor:chestplate_mese", {
		description = "Mese Chestplate",
		inventory_image = "3d_armor_inv_chestplate_mese.png",
		groups = {armor_torso=17, armor_heal=8, armor_use=250},
		wear = 0,
	})
	minetest.register_tool("3d_armor:leggings_mese", {
		description = "Mese Leggings",
		inventory_image = "3d_armor_inv_leggings_mese.png",
		groups = {armor_legs=17, armor_heal=8, armor_use=250},
		wear = 0,
	})
	minetest.register_tool("3d_armor:boots_mese", {
		description = "Mese Boots",
		inventory_image = "3d_armor_inv_boots_mese.png",
		groups = {armor_feet=12, armor_heal=8, armor_use=250},
		wear = 0,
	})
end
